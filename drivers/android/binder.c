 ...
 *
 * Adds the work to the specified list.
 */
static void
...
static int binder_transaction_log_show(struct seq_file *m, void *unused)
{
	...
	unsigned count = atomic_read(&log->cur) + 1;
	...
	if (count != atomic_read(&log->cur) + 1)
		seq_puts(m, "WARNING: log index changed while printing\n");
	return 0;
}
