 ...
 *                        @proc is NULL. @lock also used to protect
 *                        release when @proc becomes NULL)
			       ...
			       binder_size_t extra_buffers_size)
{
	...
	WRITE_ONCE(e->debug_id_done, e->debug_id);
	/*
