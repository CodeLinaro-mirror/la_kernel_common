...
struct binder_buffer *binder_alloc_buffer_lookup_locked(
 ...
 * @user_ptr:	User version of the buffer pointer
 *
 * Find the buffer given the user version of the pointer.
 *
 ...
 * @offsets_size:       size of user data buffer
 * @extra_buffers_size: size of user data buffer
 * @is_async:           size of user data buffer
 *
 ...
 * @m:i    seq_file for output via seq_printf()
 * @alloc: binder_alloc for this proc
 *
 ...
 * @alloc: binder_alloc for this proc
 *
 * Prints the count of allocated buffers to the given seq_file
 */
