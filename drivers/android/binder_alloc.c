...
err_down_write_mmap_sem_failed:
	 ...
	 * This should be mmput_async(mm), but mmput_async
	 * doesn't exist on the wahoo kernel branch. There
	 * is a possible (but very unlikely) sleep-while-atomic
	 * with the non-async version
	 */
	mmput(mm);
err_mmget:
