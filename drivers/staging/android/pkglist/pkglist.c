...
static char *config_location = "sdcardfs";
module_param(config_location, charp, 0);
MODULE_PARM_DESC(config_location, "Location of pkglist in configfs");
				...
				const char *page, size_t count)
{
	...
	ret = make_kuid(current_user_ns(), tmp).val;
...
struct extensions_value_attribute extensions_value_attr_##_name = \
			__CONFIGFS_ATTR(_name, _mode, _show, _store)
